#!/bin/sh
version_num=`cat $1`
mvn package -B -fdynatrace-service-broker-source-code/pom.xml -Dmaven.test.skip=true
...
mv dynatrace-service-broker-source-code/target/dynatrace-service-broker.jar ./dynatrace-service-broker-version.jar